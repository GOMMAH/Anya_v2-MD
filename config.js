...
module.exports = {
     ...
     */
    ownername: process.env.OWNER_NUMBER || process.env.Owner_Name || "GOMMAH",
    ownernumber: process.env.Owner_Number || "233243565321",
    ...
    sessionId: process.env.SESSION_ID || "vKSVQQ_A_N_Y_A_V_2_ctLM0ufyceXEMS",
